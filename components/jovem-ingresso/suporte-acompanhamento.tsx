            ...
            <CarouselContent className="-ml-2 md:-ml-4">
              ...
              <CarouselItem className="pl-2 md:pl-4 basis-[85%] md:basis-[45%] lg:basis-[30%]">
                <Link href="/corpo-docente">
                  <Card className="p-6 h-full hover:shadow-lg transition-shadow cursor-pointer border-dashed border-2 flex flex-col items-center justify-center text-center min-h-[320px]">
