  ...
  const formas: FormaIngresso[] = [
    {
      ...
      title: "Vestibular",
      description: "Faça nossa prova de ingresso e garanta sua vaga. Processo seletivo ágil e objetivo.",
    ...
    },
    {
      ...
      description: "Use sua nota do ENEM para ingressar sem precisar fazer vestibular.",
    ...
    },
    {
      ...
      description: "Já tem diploma de graduação? Ingresse direto sem processo seletivo.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {formas.map((forma, index) => (
            <Card key={index} className="flex flex-col items-center text-center p-8 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-3">{forma.title}</h3>
              <p className="text-muted-foreground mb-6 flex-grow">{forma.description}</p>
